...
<x-hexagonal::navbar>
    ...
    <x-slot:right-side>
        ...
        <!-- Notifications -->
        <x-hexagonal::navbar.item id="notifications" text="View notifications">
            <!-- Bell icon -->
            ...
            <x-slot:dropdown>
                ...
                <x-hexagonal::navbar.dropdown big-list header="Notifications">

                    <x-hexagonal::navbar.dropdown.link time="a few moments ago" href="#">
                        <x-slot:icon><x-hexagonal::icon.user/></x-slot:icon>
                        New message from Bonnie Green: "Hey, what's up? All set for the presentation?"
                    </x-hexagonal::navbar.dropdown.link>

                    <x-hexagonal::navbar.dropdown.link time="10 minutes ago" href="#">
                        <x-slot:icon><x-hexagonal::icon.user/></x-slot:icon>
                        Jese leos and 5 others started following you.
                    </x-hexagonal::navbar.dropdown.link>

                    <x-hexagonal::navbar.dropdown.link time="44 minutes ago" href="#">
                        <x-slot:icon><x-hexagonal::icon.user/></x-slot:icon>
                        Joseph Mcfall and 141 others love your story. See it and view more stories.
                    </x-hexagonal::navbar.dropdown.link>

                    <x-hexagonal::navbar.dropdown.link time="1 hour ago" href="#">
                        <x-slot:icon><x-hexagonal::icon.user/></x-slot:icon>
                        Leslie Livingston mentioned you in a comment: @bonnie.green what do you say?
                    </x-hexagonal::navbar.dropdown.link>

                    <x-hexagonal::navbar.dropdown.link time="3 hours ago" href="#">
                        <x-slot:icon><x-hexagonal::icon.user/></x-slot:icon>
        ...
        <!-- Apps -->
        <x-hexagonal::navbar.item id="apps" text="View other links of the application">
            <!-- Apps icon -->
            ...
            <x-slot:dropdown>
                ...
                <x-hexagonal::navbar.dropdown big-square header="Apps">

                    <x-hexagonal::navbar.dropdown.link href="#" text="Sales">
                    ...
                    <x-hexagonal::navbar.dropdown.link href="#" text="Users">
                    ...
                    <x-hexagonal::navbar.dropdown.link href="#" text="Inbox">
                    ...
                    <x-hexagonal::navbar.dropdown.link href="#" text="Profile">
                    ...
                    <x-hexagonal::navbar.dropdown.link href="#" text="Settings">
                    ...
                    <x-hexagonal::navbar.dropdown.link href="#" text="Products">
                    ...
                    <x-hexagonal::navbar.dropdown.link href="#" text="Pricing">
                    ...
                    <x-hexagonal::navbar.dropdown.link href="#" text="Billing">
                    ...
                    <x-hexagonal::navbar.dropdown.link href="#" text="Logout">
        ...
        <x-hexagonal::navbar.item user id="user" text="Open user menu">
            <!-- User icon -->
            <x-hexagonal::icon.user class="h-8 w-8 hover:bg-gray-700 hover:dark:bg-gray-300"/>

            <x-slot:dropdown>

                <x-hexagonal::navbar.dropdown>
                    <x-slot:header href="#">
                        <x-hexagonal::navbar.dropdown.user-info name="Neil Sims" email="name@flowbite.com"/>
                    </x-slot:header>

                    <x-hexagonal::navbar.dropdown.link href="#">My profile</x-hexagonal::navbar.dropdown.link>

                    <x-hexagonal::navbar.dropdown.link href="#">Account settings</x-hexagonal::navbar.dropdown.link>
                    ...
                    <x-hexagonal::navbar.dropdown.link href="#">Sign out</x-hexagonal::navbar.dropdown.link>
                </x-hexagonal::navbar.dropdown>
