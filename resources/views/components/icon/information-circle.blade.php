...
@if($attributes->has('flowbite'))
    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20" class="{{ getIconClasses($attributes, 4) }}" {{ getOtherAttributes($attributes) }}>
