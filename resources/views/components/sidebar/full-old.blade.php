<x-hexagonal::sidebar>
    <x-slot:header>
        <x-hexagonal::sidebar.search-from/>
    </x-slot:header>

    <x-hexagonal::sidebar.item href="{{ route('shared.testJs') }}">
        <x-slot:icon>
    ...
    <x-hexagonal::sidebar.item>
        ...
        <x-slot:dropdown id="pages">
            <x-hexagonal::sidebar.item subitem href="{{ route('home.example1') }}">Settings</x-hexagonal::sidebar.item>
            <x-hexagonal::sidebar.item subitem href="{{ route('home.example2') }}">Kanban</x-hexagonal::sidebar.item>
            <x-hexagonal::sidebar.item subitem href="{{ route('home.example3') }}">Calendar</x-hexagonal::sidebar.item>
        </x-slot:dropdown>
    </x-hexagonal::sidebar.item>
    ...
    <x-hexagonal::sidebar.item>
        ...
        <x-slot:dropdown id="sales">
            <x-hexagonal::sidebar.item subitem href="{{ route('shared.compare') }}">Products</x-hexagonal::sidebar.item>
            <x-hexagonal::sidebar.item subitem>Billing</x-hexagonal::sidebar.item>
            <x-hexagonal::sidebar.item subitem>Invoice</x-hexagonal::sidebar.item>
        </x-slot:dropdown>
    </x-hexagonal::sidebar.item>

    <x-hexagonal::sidebar.item href="#" counter="4">
        <x-slot:icon>
    ...
    <x-hexagonal::sidebar.item>
        ...
        <x-slot:dropdown id="authentication">
            <x-hexagonal::sidebar.item subitem>Sign In</x-hexagonal::sidebar.item>
            <x-hexagonal::sidebar.item subitem>Sign Up</x-hexagonal::sidebar.item>
            <x-hexagonal::sidebar.item subitem>Forgot Password</x-hexagonal::sidebar.item>
        </x-slot:dropdown>
    </x-hexagonal::sidebar.item>

    <x-hexagonal::sidebar.separator/>

    <x-hexagonal::sidebar.item href="#">
        <x-slot:icon>
    ...
    <x-slot:footer>
        <x-hexagonal::sidebar.footer>
            <x-hexagonal::sidebar.footer.item href="#">
            ...
            <x-hexagonal::sidebar.footer.item href="#" id="settings" tooltip="Settings page">
            ...
            <x-hexagonal::sidebar.footer.item id="language">
